# Stable Borel Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/stable-borel-conjecture-canonical-lane-mathlib.git
cd stable-borel-conjecture-canonical-lane-mathlib
lake exe
lake build
```

/-!
# stable-borel-conjecture-canonical-lane Lean migration boundary
...
`StableBorelConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "stable-borel-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/stable-borel-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Stable Borel conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["geometric-group-theory", "geometric-topology", "manifold-theory", "mathematical-proof", "reproducibility", "topological-rigidity", "stable-borel-conjecture", "canonical-lane", "local-to-global", "manifold-constrained"]
